...
public class DoctorMainDashController implements Initializable {

    @FXML
    private AnchorPane doctorMainDashAnchPane;
    @FXML
    ...
    @FXML
    private ImageView treatmentIcon;
    @FXML
    private ImageView manageMedicinesIcon;
    @FXML
    private ImageView previousTreatmentsIcon1;
    @FXML
    private ImageView previousTreatmentsIcon2;

    @Override
    public void initialize(URL location, ResourceBundle resources) {
        System.gc();

        selectionTitleLbl.setText("Welcome to Doctor's Main Dash.");
    ...
    private void loadLogoutHBoxAction() {
        ...
        if (action.get() == ButtonType.OK) {
            try {
                ...
                Scene temp = new Scene(root);
                Stage stage = (Stage) this.doctorMainDashAnchPane.getScene().getWindow();
                stage.setScene(temp);
                stage.centerOnScreen();
    ...
    @FXML
    public void doctorMainDashIcon_onMouseEntered(MouseEvent mouseEvent) {
        if (mouseEvent.getSource() instanceof ImageView) {
            ImageView icon = (ImageView) mouseEvent.getSource();

            switch (icon.getId()) {
                case "treatmentIcon":
                    selectionTitleLbl.setText("Treatment");
                    selectionDescriptionLbl.setText("Click to make treatments to patients.");
                    break;
                case "manageMedicinesIcon":
                    selectionTitleLbl.setText("Drug Pack Management");
                    selectionDescriptionLbl.setText("Click to manage your Favourite Drug Packs.");
                    break;
                case "previousTreatmentsIcon2":
                    selectionTitleLbl.setText("Previous Treatments");
                    selectionDescriptionLbl.setText("Click to see what you have done in past.");
                    break;
            }
    ...
    @FXML
    public void doctorMainDashIcon_onMouseExited(MouseEvent mouseEvent) {
        ImageView icon = (ImageView) mouseEvent.getSource();
        ScaleTransition scaleT = new ScaleTransition(Duration.millis(200), icon);
        scaleT.setToX(1);
        scaleT.setToY(1);
    ...
    @FXML
    public void treatmentIcon_onMouseClicked(MouseEvent event) {
        loadDoctorDashBoardOptions("doctor_patientTreatment", "Patient Treatments");
    }

    @FXML
    public void manageMedicinesIcon_onMouseClick(MouseEvent event) {
        loadDoctorDashBoardOptions("doctor_drugPackManagement", "Drug Pack Management");
    }

    @FXML
    public void previousTreatmentsIcon_onMouseClicked(MouseEvent event) {
        loadDoctorDashBoardOptions("doctor_previousTreatment", "Previous Treatment");
    }

    public void loadDoctorDashBoardOptions(String fxmlFileName, String title) {
        try {
            Parent root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/dcs/view/" + fxmlFileName + ".fxml"));
            Scene temp = new Scene(root);
            Stage stage = (Stage) this.doctorMainDashAnchPane.getScene().getWindow();
            stage.setScene(temp);
            stage.setTitle("New Philip Hospitals - Doctor Channelling System >>> Doctor's Main DashBoard >>>" + title);
            stage.setResizable(false);
            stage.show();
