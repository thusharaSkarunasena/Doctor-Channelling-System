...
public class CashierMainDashController implements Initializable {

    @FXML
    private AnchorPane cashierMainDashAnchPane;
    @FXML
    ...
    @FXML
    private ImageView paymentManagementIcon;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        selectionTitleLbl.setText("Welcome to Cashier's Main Dash.");
    ...
    private void loadLogoutHBoxAction() {
        ...
        if (action.get() == ButtonType.OK) {
            try {
                ...
                Scene temp = new Scene(root);
                Stage stage = (Stage) this.cashierMainDashAnchPane.getScene().getWindow();
                stage.setScene(temp);
                stage.centerOnScreen();
    ...
    @FXML
    public void cashierMainDashIcon_onMouseEntered(MouseEvent mouseEvent) {
        if (mouseEvent.getSource() instanceof ImageView) {
            ImageView icon = (ImageView) mouseEvent.getSource();

            switch (icon.getId()) {
                case "paymentManagementIcon":
                    selectionTitleLbl.setText("Payment Management");
                    selectionDescriptionLbl.setText("Click to manage payment.");
                    break;
                case "paymentHistoryIcon":
                    selectionTitleLbl.setText("Payment History");
                    selectionDescriptionLbl.setText("Click to see payment History.");
                    break;
            }
    ...
    @FXML
    public void cashierMainDashIcon_onMouseExited(MouseEvent mouseEvent) {
        ImageView icon = (ImageView) mouseEvent.getSource();
        ScaleTransition scaleT = new ScaleTransition(Duration.millis(200), icon);
        scaleT.setToX(1);
        scaleT.setToY(1);
    ...
    @FXML
    public void paymentManagementIcon_onMouseClicked(MouseEvent event) {
        loadCashierDashBoardOptions("cashier_paymentManagement", "Payment Management");
    }

    @FXML
    public void paymentHistoryIcon_onMouseClicked(MouseEvent event) {
        loadCashierDashBoardOptions("cashier_paymentHistory", "Payment History");
    }

    public void loadCashierDashBoardOptions(String fxmlFileName, String title) {
        try {
            Parent root = FXMLLoader.load(this.getClass().getResource("/lk/ijse/dcs/view/" + fxmlFileName + ".fxml"));
            Scene temp = new Scene(root);
            Stage stage = (Stage) this.cashierMainDashAnchPane.getScene().getWindow();
            stage.setScene(temp);
            stage.setTitle("New Philip Hospitals - Doctor Channelling System >>> Cashier's Main DashBoard >>>" + title);
            stage.setResizable(false);
            stage.show();
